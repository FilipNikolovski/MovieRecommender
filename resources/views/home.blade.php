...
@section('content')
        ...
        <div class="container">
            <div class="intro-text">
                ...
                <form action="{{action('MoviesController@getSearch')}}" method="GET">
                    <input type="text" name="search" id="search" class="form-control" placeholder="Search Movies..."
                           required>
                </form>
            </div>
        </div>
                ...
                @foreach($randomMovies as $movie)
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <p class="text-muted">{{str_limit($movie['overview'], 100)}} <a
                                        href="{{url('/movies/'.$movie['id'])}}">More</a></p>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <section id="portfolio" class="bg-light-gray">
        <div class="container">
            ...
            <div class="grid-home-tv">
                <div class="grid-sizer-home"></div>
                @foreach($randomTv as $tvShow)
                    <div class="portfolio-item">
                        <a href="{{url('/tv-shows/'.$tvShow['id'])}}" class="portfolio-link" data-toggle="modal">
                            <div class="portfolio-hover">
                                <div class="portfolio-hover-content">
                                    <i class="fa fa-plus fa-3x"></i>
                                </div>
